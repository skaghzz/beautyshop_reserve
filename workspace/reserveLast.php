...
<form action=doreserve.php?keyValue=<?=$row['keyValue']?> method=post>
    ...
    <div class="topBar">
        ...
        <!--옵션-->
        <div class="selectName" id="optionName">옵션</div>
        
        <select id="type" name="type" value ="선택하세요" class="select" >
        <option value="">항목선택</option>
        <option value="컷">컷(30분단위)</option>
        <option value="펌">펌(1시간단위)</option>
        <option value="염색">염색(1시간단위)</option>
        <option value="몰라">마음대로(30분단위)</option>
        </select>
            ...
            <script>
                    $(document).ready(function() {
                        $('#type').click(function(){
                            ...
                            var ht2 ="";
                            if(type=="컷"||type=="몰라"){//30분 단위 일 때
                                ht2 +=  "<option value=09:00>09:00</option>"+
                            ...
                            }else if(type=="펌"||type=="염색"){//1시간 단위 일 때
                                ht2 +=  
