...
<body>
    ...
    <table id="ta" cellpadding=0 cellspacing=0 width="300" height="30" border="0" radius="3" rborder="" rbgcolor="#e1716f">
            <td valign="center" align ="center">
                <!--<table id="tab" cellpadding=0 cellspacing=0 width="148.5" height="27" border="0" radius="3" rborder="" rbgcolor="e1716f">-->
                    <td align="center"><input type="button" value="예약현황" class="buttonnotchoice" onclick="location.href='myPage_new.php'"></td>

            </td>
            <td valign="center" align ="center">
                    <td align="center"><input type="button" value="지난" class="buttonchoice"></td>
            </td>
    </table>
    </center>
    ...
    <BR>
        <!-- 게시물 리스트를 보이기 위한 테이블 -->
        <?php if($count == 0):?>
            <table><font color ="e1716f">예약 내역이 없습니다</font></table>
        <?php else :?>
            <?php while ($row = mysqli_fetch_array($result)){ ?>
            <?php if(mktime(0,0,0,$row['reserveDay'],$row['reserveMonth'],2016) < mktime()):?>
            
                 <table height=150 width=300 bgcolor="#d0d0d0">
                    <tr>
                        <!-- 샵 이름 시작-->
